...
export interface AccessInput {
   ...
   * "anyone at acme.com". Resolved by the caller with SQL equality, never a
   * suffix test: a rule for acme.com must not admit evil-acme.com, which anyone
   * can register.
   */
   ...
   * without this a rule for acme.com would admit anyone who typed a acme.com
 ...
 * one: reading the LAST field instead would make `dana@acme.com@evil.com` look
 * like acme.com while mail routes to evil.com — enough to satisfy a domain rule
