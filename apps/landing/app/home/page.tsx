...
// page, / is untouched. Everything visual lives in `home.css`; this file is
// structure and words.
//
...
const PLANS = [
  ...
  },
  {
    ...
    cta: "Talk to us",
    href: "mailto:founders@supersonic.cv?subject=Bay%20Team%20plan",
    fill: false,
  },
];
      ...
      <footer className="b-foot">
        <div className="b-wrap">
          ...
          <div className="b-fcol">
            ...
            <a href="mailto:founders@supersonic.cv">Contact</a>
