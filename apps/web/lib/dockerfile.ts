...
// The generated Dockerfile carries our name in its first comment, which the user
// reads in their own build log.
...
export function generateDockerfile(i: DockerfileInput): string {
  ...
  const lines: string[] = [
    ...
    `# Generated by ${productName()}. Your repo is unchanged — this lives in the build copy.`,
